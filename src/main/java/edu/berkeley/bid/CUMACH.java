...
public final class CUMACH {
    ...
    public static native int word2vecConv(int nrows, int ncols, int shift, Pointer W, Pointer A, Pointer B, float lrate);
    ...
    public static native int word2vec(int nrows, int ncols, int nwa, int nwb, Pointer WA, Pointer WB, Pointer A, Pointer B, float lrate);
