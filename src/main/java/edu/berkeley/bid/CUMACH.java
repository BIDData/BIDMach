...
public final class CUMACH {
    ...
    public static native int word2vecFwd(int nrows, int ncols, Pointer WA, int nwa, Pointer WB, int nwb, Pointer A, Pointer B, Pointer C);
    
    public static native int word2vecBwd(int nrows, int ncols, Pointer WA, int nwa, Pointer WB, int nwb, Pointer A, Pointer B, Pointer C, float lrate, int AnotB);
