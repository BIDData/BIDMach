...
SET LIBDIR="%CD%\..\BIDMat\lib"
SET JCUDA_LIBDIR=%LIBDIR%
SET PATH=%LIBDIR%\win64;%LIBDIR%\win64\JCUDA5.0;%PATH%

SET BIDMACH_LIBS=%LIBDIR%\..\BIDMat.jar;%CD%\BIDMach.jar;%LIBDIR%\ptplot.jar;%LIBDIR%\ptplotapplication.jar;%LIBDIR%\jhdf5.jar;%LIBDIR%\commons-math3-3.1.1.jar
