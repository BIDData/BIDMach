...
if [ ! -e tokenized/dict.gz ]; then
    ...
    ${BIDMACH_SCRIPTS}/../../BIDMat/src/main/C/newparse/trec -i $allfiles -o tokenized/
...
if [ ! -e "catname.imat" ]; then
    ${BIDMACH_SCRIPTS}/../../BIDMat/src/main/C/newparse/tparse -i rcv1-v2.topics.qrels.gz -f ${RCV1}/fmt.txt -o ./ -m ./ -d " "
fi
